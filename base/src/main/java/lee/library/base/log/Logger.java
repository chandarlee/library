...
public abstract class Logger {
    ...
    public static Logger init(Context context, String fileName, Handler handler){
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT && context.checkCallingOrSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
